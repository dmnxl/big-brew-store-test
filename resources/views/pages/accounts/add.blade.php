...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Create Account</li>
        </ol>
    </nav>
@endsection
                ...
                <div class="row p-5">
                    <div class="col-lg-6">
                        ...
                        <div class="input-group">
                            <input type="text" name="username" class="form-control font-weight-bold" placeholder="User Name" value="" id="basic-url" aria-describedby="basic-addon3" required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label class="form-control-label" for="basic-url">Email</label>
                        <div class="input-group">
                            <input type="email" name="email" class="form-control font-weight-bold" placeholder="Email" value="" id="basic-url" aria-describedby="basic-addon3" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group">
                            <input type="password" name="password" class="form-control font-weight-bold" placeholder="password" value="" id="basic-url" aria-describedby="basic-addon3" minlength="8" required>
                        </div>
