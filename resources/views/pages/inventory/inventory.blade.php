        ...
        <div class="card-header pb-0">
            <div class="row">
                ...
                <div class="text-end col-lg-3">
                    <button href="#" class="btn btn-md bg-gradient-success" data-bs-toggle="modal" data-bs-target="#ModalInventory"><i class="fa fa-solid fa-plus"></i> Add Ingredients</button>
                    @include('pages.inventory.add')
                </div>
                <div class="text-end col-lg-3">
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        if(tableBody && paginationContainer && entriesInfo){
            ...
            const fetchData = (page = 1, search = '') => {
                ...
                axios.get(`{{ route('invDataIngredients') }}?page=${page}&search=${search}`)
                .then(function(response){
                    ...
                    if(Array.isArray(inventoryData)){
                        ...
                        document.querySelectorAll('.edit-btn').forEach(btn => {
                            btn.addEventListener('click', function() {
                                ...
                                document.getElementById('ModalEditGrp').addEventListener('click', function(event){
                                    ...
                                    axios.post('{{ route('checkInventory') }}', {ingredientsName: ingredientsName, stock: stock, inv_id: inv_id})
                                    .then(function(response){
                        ...
                        console.error('Data received is not an array:', inventoryData);
                    }
                })
                .catch(function(error){
            ...
            addIngredientsForm.addEventListener('submit', async function(event) {
                ...
                try{
                    ...
                    if (checkResponse.data.exists) {
                        ...
                        try {
                            var storeResponse = await axios.post('{{ route('invenstore') }}', formData);
