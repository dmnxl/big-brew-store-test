    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h3 class="modal-title" id="ModalInventoryLabel">Add Inventory</h3>
            </div>
            <form action="" method="POST" id="AddIngredientsForm">
                ...
                <div class="modal-body text-start">
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="basic-url">Ingredients Name <span class="text-danger">*</span></label>
                            <input type="text" name="ingredients-name" class="form-control" placeholder="Input Ingredients Name" required>
                        </div>
                        <div class="col-lg-12">
